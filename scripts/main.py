    ...
    with open(CHANNEL_LIST, "r") as file:
        for line in file:
            ...
            if not line.startswith('https'):
                ...
                parts = line.split('|')
                if len(parts) != 4:
                    print(f"Error: Invalid metadata format -> {line}")
                    continue
